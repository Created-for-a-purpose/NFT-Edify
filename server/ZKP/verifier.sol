...
contract PlonkVerifier {
    ...
    uint256 constant Qlx  = 21472575066216892043268675489425545121580144729301618508324043221798948411246;
    uint256 constant Qly  = 9261642165985998816891281608756222604856691671176996246100954816977031042011;
    uint256 constant Qrx  = 0;
    uint256 constant Qry  = 0;
    uint256 constant Qox  = 0;
    uint256 constant Qoy  = 0;
    uint256 constant Qcx  = 13936039340737889009318506711103340397435555199616688829792356096561150902092;
    uint256 constant Qcy  = 11664292554451677858913847782398570886198565894378642134166034175205459546100;
    uint256 constant S1x  = 4059903112689565311554466895472743861067464728934252021611722383896642643559;
    uint256 constant S1y  = 4380356710846036028385437936813852154382474707882304651292206616188056189371;
    uint256 constant S2x  = 1723700919945238507178653416725367220259636103077010577840685199488600972209;
    uint256 constant S2y  = 754203209650977567917896541691315966234432445605796675344161425143761159112;
    uint256 constant S3x  = 1811722642589987920589766116446988120946645960877070247158712307382164338395;
    uint256 constant S3y  = 16956479146622156247311299607887434529446071764122473579835017620077829377402;
    uint256 constant k1   = 2;
    uint256 constant k2   = 3;
    uint256 constant X2x1 = 8808478869388479790215491478177777882438899946251016284348308740249770000457;
    uint256 constant X2x2 = 21550757966095536251847082776289504667336243367769132386571659216606004336315;
    uint256 constant X2y1 = 19673503446232124736205716351555579844296786799237076503780336102589924038681;
    uint256 constant X2y2 = 157019667181268814253865447299251979766893897942561982569486204162605944058;
